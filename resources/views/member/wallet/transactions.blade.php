                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            @foreach($transactions as $tx)
                                @php
                                    // ✅ Safe fallback if wallet relationship is missing
                                    $walletType = $tx->wallet->type ?? 'unknown';
                                @endphp
                                <tr>
                                    <td>
                                        <span class="badge 
                                            @if($walletType == 'commission') bg-teal-blue
                                            @elseif($walletType == 'rank') bg-red
                                            @elseif($walletType == 'shopping') bg-dark-gray
