...
<div class="container-fluid px-4">
    ...
    <!-- Recent Transactions & Pending Funding -->
    <div class="row g-4">
        <div class="col-lg-8">
                            ...
                            @foreach($recentTransactions as $tx)
                                <div class="list-group-item px-0 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <br>
                                        <!-- ✅ FIX: Use null coalescing in case wallet relationship is missing -->
                                        <small class="text-muted text-capitalize">{{ $tx->wallet->type ?? 'N/A' }} wallet</small>
                                    </div>
                                </div>
                            @endforeach
                        </div>
