...
@section('title', 'Rank Award Wallet - Happylife')
...
<div class="container-fluid px-4">
    ...
    <!-- Wallet Header -->
    <div class="bg-red text-white rounded-4 p-4 mb-4 shadow">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <p class="small opacity-75 mb-1">Rank Award Wallet</p>
        ...
        <div class="card-body">
            ...
            @else
                <div class="text-center py-5 text-muted">
                    ...
                    <p class="mt-3 fs-5">No rank bonus transactions yet.</p>
                    <p class="small">When you claim a rank, the reward will be credited here.</p>
                </div>
            @endif
        </div>
    </div>
