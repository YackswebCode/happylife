    ...
    <div class="row g-5">
        ...
        <div class="col-md-6">
            <div class="card product-card p-4 h-100">
                ...
                <!-- Add to Cart -->
                <div class="mt-3">
                    <form action="{{ route('member.shopping.cart.add') }}" method="POST" id="addToCartForm">
                        @csrf
                        ...
                        <div class="card product-card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('member.shopping.product', $related->id) }}" class="btn btn-sm btn-outline-happylife-teal">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
