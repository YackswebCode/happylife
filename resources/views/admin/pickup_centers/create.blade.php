...
@section('title', 'Add Pickup Center')

@section('content')
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 text-dark-gray fw-bold">Add New Pickup Center</h2>
    ...
    <form action="{{ route('admin.pickup-centers.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('operating_hours') is-invalid @enderror" id="operating_hours" name="operating_hours" value="{{ old('operating_hours') }}" required>
                            <small class="text-muted">e.g., Mon-Fri 9am-5pm, Sat 10am-2pm</small>
                        </div>
                        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-red mt-3 px-4 py-2">Create Pickup Center</button>
    </form>
</div>
@endsection