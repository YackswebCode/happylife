            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($provider->logo)
                                <img src="{{ asset('storage/'.$provider->logo) }}" alt="{{ $provider->name }}" style="width: 30px; height: 30px; object-fit: contain;">
                            @else
                    ...
                    @empty
                    <tr><td colspan="7" class="text-center py-4 text-muted">No providers found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
