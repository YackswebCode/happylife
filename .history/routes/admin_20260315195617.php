...
Route::prefix('vtu')->name('vtu.')->group(function () {
    Route::resource('api-settings', App\Http\Controllers\Admin\VtuApiSettingController::class);
    Route::resource('providers', App\Http\Controllers\Admin\VtuProviderController::class);
    Route::resource('plans', App\Http\Controllers\Admin\VtuPlanController::class);
    Route::resource('transactions', App\Http\Controllers\Admin\VtuTransactionController::class)->only(['index', 'show']);
});
});
});