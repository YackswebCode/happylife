...
Route::get('/matching-bonus', [App\Http\Controllers\Member\MatchingController::class, 'index'])
    ->name('member.matching.index');
...
Route::get('/member/profile/states/{country}', 
    [App\Http\Controllers\Member\ProfileController::class, 'getStates']
)->name('member.profile.states');
/*
|--------------------------------------------------------------------------
