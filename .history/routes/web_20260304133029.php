...
Route::prefix('vtu')->name('vtu.')->group(function () {
    ...
    Route::get('/plans', [App\Http\Controllers\Member\VTUController::class, 'getPlans'])->name('plans');
    ...
    Route::get('/cable-plans', [App\Http\Controllers\Member\VTUController::class, 'getCablePlans'])->name('cable.plans'); // THIS MUST EXIST
    Route::post('/validate-smartcard', [App\Http\Controllers\Member\VTUController::class, 'validateSmartCard'])->name('validate.smartcard');

    // Electricity
    Route::get('/electricity', [App\Http\Controllers\Member\VTUController::class, 'electricity'])->name('electricity');
    Route::post('/electricity/purchase', [App\Http\Controllers\Member\VTUController::class, 'purchaseElectricity'])->name('electricity.purchase');
});
    // Withdrawals
