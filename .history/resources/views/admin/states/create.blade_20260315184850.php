...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 text-dark-gray fw-bold">Add New State</h2>
    ...
    <form action="{{ route('admin.states.store') }}" method="POST">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">e.g., NG-LA for Lagos</small>
                        </div>
                        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-red mt-3 px-4 py-2">Create State</button>
    </form>
</div>
@endsection