...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 text-dark-gray fw-bold">Edit State: {{ $state->name }}</h2>
    ...
    <form action="{{ route('admin.states.update', $state) }}" method="POST">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code', $state->code) }}" required>
                        </div>
                        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-red mt-3 px-4 py-2">Update State</button>
    </form>
</div>
@endsection