...
@section('title', 'Add Repurchase Product')

@section('content')
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 text-dark-gray fw-bold">Add New Repurchase Product</h2>
    ...
    <form action="{{ route('admin.repurchase-products.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('pv_value') is-invalid @enderror" id="pv_value" name="pv_value" value="{{ old('pv_value') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
