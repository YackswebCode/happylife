...
<head>
    ...
    <style>
        /* Copy all styles from the member layout – same design language */
        :root {
            --color-red: #E63323;
        ...
        * {
        ...
        .sidebar-menu ul li .nav-link .bi-chevron-down {
            float: right;
            transition: transform 0.3s;
        }

        .sidebar-menu ul li .nav-link[aria-expanded="true"] .bi-chevron-down {
...
<body>
    ...
    <div id="sidebar">
        <div class="sidebar-header">
            <h3 class="text-center">
                ...
                @else
                    <i class="bi bi-shield-lock-fill text-red"></i>
                    <span class="text-red" style="font-weight: 800;">HAPPYLIFE</span>
                @endif
            </h3>
            <div class="text-center mt-2">
                <small class="text-light-gray" style="font-size: 0.8rem;">ADMIN PANEL</small>
            </div>
        </div>
            ...
            <div class="user-info">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-light-gray">{{ Auth::guard('admin')->user()->email }}</small>
                    </div>
                </div>
            </div>
            ...
            <div class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    @if($role == 'super_admin' || $role == 'admin')
                        ...
                        <!-- Sales & Orders -->
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#salesMenu" role="button" aria-expanded="false" aria-controls="salesMenu">
                            ...
                            <div class="collapse" id="salesMenu">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item {{ request()->routeIs('admin.withdrawals.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.withdrawals.index') }}" class="nav-link">
                                            <i class="bi bi-cash-stack"></i> Withdrawals
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.funding-requests.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.funding-requests.index') }}" class="nav-link">
                                            <i class="bi bi-piggy-bank"></i> Funding Requests
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="productMenu">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item {{ request()->routeIs('admin.landing-products.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.landing-products.index') }}" class="nav-link">
                                            <i class="bi bi-megaphone"></i> Landing Products
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item {{ request()->routeIs('admin.repurchase-products.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.repurchase-products.index') }}" class="nav-link">
                                            <i class="bi bi-cart4"></i> Repurchase
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.product-claims.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.product-claims.index') }}" class="nav-link">
                                            <i class="bi bi-tag"></i> Product Claims
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- MLM -->
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#mlmMenu" role="button" aria-expanded="false" aria-controls="mlmMenu">
                                <i class="bi bi-diagram-3"></i> MLM
                                <i class="bi bi-chevron-down"></i>
                            </a>
                            <div class="collapse" id="mlmMenu">
                                <ul class="nav flex-column">
                                    <li class="nav-item {{ request()->routeIs('admin.packages.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.packages.index') }}" class="nav-link">
                                            <i class="bi bi-gift"></i> Packages
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.ranks.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.ranks.index') }}" class="nav-link">
                                            <i class="bi bi-trophy"></i> Ranks
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.upgrades.*') ? 'active' : '' }}">
                        ...
                        <!-- Content -->
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#contentMenu" role="button" aria-expanded="false" aria-controls="contentMenu">
                        ...
                        <!-- Location -->
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#locationMenu" role="button" aria-expanded="false" aria-controls="locationMenu">
                                <i class="bi bi-geo-alt"></i> Location
                                <i class="bi bi-chevron-down"></i>
                            </a>
                            <div class="collapse" id="locationMenu">
                                <ul class="nav flex-column">
                                    <li class="nav-item {{ request()->routeIs('admin.states.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.states.index') }}" class="nav-link">
                                            <i class="bi bi-geo-alt"></i> States
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.pickup-centers.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.pickup-centers.index') }}" class="nav-link">
                                            <i class="bi bi-pin-map"></i> Pickup Centers
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- VTU -->
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#vtuMenu" role="button" aria-expanded="false" aria-controls="vtuMenu">
                                <i class="bi bi-wifi"></i> VTU
                                <i class="bi bi-chevron-down"></i>
                            </a>
                            <div class="collapse" id="vtuMenu">
                                <ul class="nav flex-column">
                                    <li class="nav-item {{ request()->routeIs('admin.vtu.providers.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.vtu.providers.index') }}" class="nav-link">
                                            <i class="bi bi-building"></i> Providers
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.vtu.plans.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.vtu.plans.index') }}" class="nav-link">
                                            <i class="bi bi-list-ul"></i> Plans
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.vtu.transactions.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.vtu.transactions.index') }}" class="nav-link">
                                            <i class="bi bi-clock-history"></i> Transactions
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.vtu.api-settings.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.vtu.api-settings.index') }}" class="nav-link">
                                ...
                                <ul class="nav flex-column">
                                    <li class="nav-item {{ request()->routeIs('admin.wallets.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.wallets.index') }}" class="nav-link">
                                            <i class="bi bi-wallet"></i> Wallets
                                        </a>
                                    </li>
                                    <li class="nav-item {{ request()->routeIs('admin.wallet-transactions.*') ? 'active' : '' }}">
                                        <a href="{{ route('admin.wallet-transactions.index') }}" class="nav-link">
                    ...
                    @if($role == 'vendor')
                        <!-- Vendor only sees Orders and Product Claims -->
                        <li class="nav-item {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.orders.index') }}" class="nav-link">
                                <i class="bi bi-cart-check"></i> Orders
                            </a>
                ...
                <div class="d-flex align-items-center ms-auto">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-light d-flex align-items-center rounded-pill" type="button" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-inline">{{ Str::limit(Auth::guard('admin')->user()->name, 15) }}</span>
    ...
    <script>
        ...
        // Update sidebar active state (handles parent active when child is active)
        document.addEventListener('DOMContentLoaded', function() {
            const currentPath = window.location.pathname;
            const navItems = document.querySelectorAll('#sidebar .nav-item');

            navItems.forEach(item => {
                const link = item.querySelector('a:not([data-bs-toggle])');
