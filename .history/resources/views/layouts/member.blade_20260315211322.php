...
<head>
    ...
    <title>@yield('title', 'Member Dashboard - ' . $siteName)</title>
        ...
        <div class="sidebar-header">
            <h3 class="text-center">
                ...
                @else
                    ...
                    <span class="text-red" style="font-weight: 800;">{{ strtoupper($siteName) }}</span>
                @endif
            </h3>
        ...
        <div class="sidebar-nav-container">
            ...
            <div class="sidebar-menu">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item {{ request()->routeIs('member.matching*') ? 'active' : '' }}">
                        <a href="{{ route('member.matching.index') }}" class="nav-link">
                            <i class="bi bi-graph-up-arrow"></i> Matching Bonus
                        </a>
                    </li>
                ...
                <li class="nav-item {{ request()->routeIs('member.announcements*') ? 'active' : '' }}">
                    <a href="{{ route('member.announcements.index') }}" class="nav-link">
