        ...
        <div class="col-md-6 col-lg-3">
            <a href="{{ route('member.vtu.airtime') }}" class="text-decoration-none">
                <div class="card product-card h-100 p-4 text-center">
                    ...
                    <span class="btn btn-sm btn-danger mt-2">Buy Now</span>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-lg-3">
        ...
        <div class="col-md-6 col-lg-3">
            <a href="{{ route('member.vtu.cable') }}" class="text-decoration-none">
                <div class="card product-card h-100 p-4 text-center">
                    ...
                    <span class="btn btn-sm btn-danger mt-2">Subscribe</span>
                </div>
            </a>
        </div>
        <div class="col-md-6 col-lg-3">
            <a href="{{ route('member.vtu.electricity') }}" class="text-decoration-none">
                <div class="card product-card h-100 p-4 text-center">
                    ...
                    <span class="btn btn-sm btn-danger mt-2">Pay Bill</span>
                </div>
            </a>
        </div>
    </div>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                @foreach($recentTransactions as $tx)
                                    <tr>
                                        <td>
                                            <span class="badge badge-danger">{{ $tx->service_type }}</span>
                                        </td>
