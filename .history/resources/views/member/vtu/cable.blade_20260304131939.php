                ...
                <form action="{{ route('member.vtu.cable.purchase') }}" method="POST" id="cableForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-4">
                            <button type="button" id="validateBtn" class="btn btn-happylife-cyan btn-lg w-100 py-3">
...
<script>
        ...
        fetch(`{{ route('member.vtu.cable.plans') }}?provider_id=${providerId}`)
            ...
            .then(plans => {
                ...
                plans.forEach(plan => {
                    ...
                    option.value = plan.id;          // API plan ID
    ...
    // Validate smart card before submission
    validateBtn.addEventListener('click', function(e) {
        ...
        if (!smartCard) {
            alert('Please enter your smart card / IUC number.');
            return;
        }
        if (!planId) {
            alert('Please select a bouquet.');
            return;
        }
