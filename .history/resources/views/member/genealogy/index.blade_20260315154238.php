...
<div class="container-fluid px-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Binary network (infinite depth)</p>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        t.node = function(node, data) {
            ...
            // Build card style: full red border for non-empty, otherwise rely on CSS (dashed)
            let cardStyle = 'width:100%; height:100%; border-radius: 8px;';
            if (!data.isEmpty) {
                cardStyle += ' border: 2px solid rgba(255, 4, 4, 0.92);';
            }

            // ----- The full HTML card -----
            let html = `
                <div class="orgchart-card ${positionClass} ${emptyClass}" style="${cardStyle}">
        ...
        // ----- 5. Initialize OrgChart with dynamic loading -----
